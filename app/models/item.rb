class Item < ApplicationRecord
  ...
  validates :item_condition_id, presence: { message: "can't be blank" }, exclusion: { in: [nil], message: "can't be blank" }
  validates :delivery_price_id, presence: { message: "can't be blank" }, exclusion: { in: [nil], message: "can't be blank" }
  validates :delivery_date_id, presence: { message: "can't be blank" }, exclusion: { in: [nil], message: "can't be blank" }
  validates :shipping_area_id, presence: { message: "can't be blank" }, exclusion: { in: [nil], message: "can't be blank" }
